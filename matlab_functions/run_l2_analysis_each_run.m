function run_l2_analysis(datapath, outdir)
    ...
    for r = 1:3
        outpath = fullfile(datapath, [outdir num2str(r)]);
        ...
        for i = 1:length(all_conds)
            ...
            %% specification
            batch = [];
            scanFiles = strcat(datapath, '/', subjids', '/proc_1st_run', num2str(r), '/con_', contrast_num, '.nii,1') % if using subjids
